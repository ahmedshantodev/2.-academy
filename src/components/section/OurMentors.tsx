...
const OurMentors = () => {
  const [active, setActive] = useState<
    (typeof mentors)[number] | boolean | null
  >(null);
  const id = useId();
  ...
  return (
    <div className="container flex items-center justify-center w-full flex-col px-4 py-10">
      <h2 className="text-2xl md:text-4xl 2xl:text-6xl text-white font-bold text-center mb-2 2xl:mb-5">
        Meet Our Instructors
      </h2>

      <p className="text-base md:text-lg lg:text-base xl:text-lg text-white text-center mb-4">
